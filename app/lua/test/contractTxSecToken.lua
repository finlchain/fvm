...
--
function contractTxSecToken.makeContractJson()
    --
    ctxToken = cTxSecToken;
    ...
    local token_num = contractActionsJson['TOKEN']['SECURITY'];
    -- contents
    local memo = '';
    ...
    ctxToken:setContractObj('to_account', to_account);
...
function contractTxSecToken.testCase()
    --
    local rtnJsonStr = contractTxSecToken.makeContractJson();
end
